...
You can add **content requests** by creating a [GitHub issue](https://github.com/UI5/docs/issues). If you want to propose changes, updates, or corrections to the documentation content, please create a **pull request**.
