...
You can use the CSV export type out of the box, or define other export types. The concept is similar to custom controls, see [Developing Controls](../07_Developing_Controls/developing-controls-8dcab00.md). The generate method is called and should return the created file as a string.
