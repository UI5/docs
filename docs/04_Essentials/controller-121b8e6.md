...
For more information on how to use a controller's metadata definition for controller extensions, see [Controller Extensions](../06_Extending_SAPUI5_Applications/controller-extensions-21515f0.md).
...
For more information on how to use controller extensions, see [Controller Extensions](../06_Extending_SAPUI5_Applications/controller-extensions-21515f0.md).
