...
[Extension Points](../06_Extending_SAPUI5_Applications/extension-points-403c050.md "Extension points are locations in application views where you can insert custom content. These points are pre-defined by the application.")
