...
-   **[ID Handling in OpenUI5: The Complete Guide](id-handling-in-openui5-the-complete-guide-f51dbb7.md "This guide covers everything you need to know about ID handling in OpenUI5,
		from stable IDs for controls and components to DOM element IDs and how the framework manages them. Understanding ID handling is essential for
		building maintainable, testable, and adaptable applications.")**  
...
[Developing Apps with SAP Fiori Elements](https://help.sap.com/viewer/93953b95df5f4e938c8eb421cef56319/1.152_SAPUI5_ABAP/en-US/03265b0408e2432c9571d6b3feb6b1fd.html "Develop apps using SAP Fiori elements and benefit from a metadata-driven approach.") :arrow_upper_right:
