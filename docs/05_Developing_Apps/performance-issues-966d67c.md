...
Please note that lazy loading of views can be achieved with routing.For more information, see [Routing and Navigation](../04_Essentials/routing-and-navigation-3d18f20.md) and [Step 10: Implement Lazy Loading](https://ui5.github.io/tutorials/navigation/steps/10/index.html/?lang=js) of the Navigation and Routing tutorial.
